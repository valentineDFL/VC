...
namespace VC.Core.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250605201828_ChangeServiceTime_Property_ColumnType_TimestampWithoutZone")]
    partial class ChangeServiceTime_Property_ColumnType_TimestampWithoutZone
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VC.Core.Services.OrderHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.PrimitiveCollection<Guid[]>("EmployeesIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.HasIndex("ServiceTime");

                    b.ToTable("OrdersHistory", "core");
                });
